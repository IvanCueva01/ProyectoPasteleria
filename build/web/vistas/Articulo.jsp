                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">RECETARIO</h1>
                            <a href="SvReceta?accion=mostraragregar" class="btn btn-secondary btn-user btn-link "
                               style="color:white; margin-left:5px">
                                <b>Agregar Receta</b></a> <br><br>
                         ...
                         <%
                                ...
                                <ul>                            
                                    <li>
                                        <a href="SvReceta?accion=editar&id=<%=arti.getId()%>">
                                            <%=arti.getTitulo()%>
                                        </a>
                                    </li>                               
                                </ul>
