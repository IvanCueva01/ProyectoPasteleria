...
<html>
    <head>
        ...
        <title>PASTELERÍA FINA "JESSI"</title>
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.jsp">
                    ...
                    <div class="sidebar-brand-text mx-3">PASTELERÍA FINA "JESSI"</div>
                </a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-6 text-gray-800 ">"DULCES MOMENTOS PARA COMPARTIR"</h1>
                        </div>
                        
                        <img src="https://cdn.kiwilimon.com/recetaimagen/3239/8548.jpg" width="45%" alt=""/>
