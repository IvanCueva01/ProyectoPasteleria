            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">PASTELERIA FINA "JESSI"</h1>
                    </div>
                    <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        %>
                        <form class="user" action="SvReceta">
                            <h1><%= arti.getTitulo()%></h1>
                            <p><%= arti.getContenido()%></p>
                            <input type="hidden" name="id" value="<%=arti.getId()%>">
                            <a class="btn btn-primary btn-user btn-block" href="SvReceta?accion=listar">Regresar</a>
                        </form>
                        <!-- /.container-fluid -->
