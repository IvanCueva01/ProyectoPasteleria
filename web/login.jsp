            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <img src="https://www.dibustock.com/wp-content/uploads/2019/11/pastry-chef-with-mustache-catching-a-delicious-cake.jpg" class="col-lg-6  d-lg-block" style="height: 50%" alt="alt"/>
